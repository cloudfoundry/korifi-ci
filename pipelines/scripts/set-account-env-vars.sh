...
CRDS_TEST_CLI_USER_TOKEN: ${CF_CRDS_USER_TOKEN:-}
...
E2E_UNPRIVILEGED_SERVICE_ACCOUNT: $E2E_UNPRIVILEGED_SERVICE_ACCOUNT
E2E_UNPRIVILEGED_SERVICE_ACCOUNT_TOKEN: $E2E_UNPRIVILEGED_SERVICE_ACCOUNT_TOKEN
